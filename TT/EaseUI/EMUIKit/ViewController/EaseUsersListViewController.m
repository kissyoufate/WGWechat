...
- (void)addFriend
{
    ...
    b.frame = CGRectMake(0, 0, 28, 30);
    [b setImage:[UIImage imageNamed:@"contacts_add_friend"] forState:UIControlStateNormal];
    [b addTarget:self action:@selector(addAfriend) forControlEvents:UIControlEventTouchUpInside];
