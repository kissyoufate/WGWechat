...
- (void)answerAction
{
    ...
    [[ChatDemoHelper shareHelper] answerCall:_callSession];
#endif
}
...
- (void)hangupAction
{
    ...
    [[ChatDemoHelper shareHelper] hangupCallWithReason:EMCallEndReasonHangup withEmcall:_callSession];
...
- (void)rejectAction
{
    ...
    [[ChatDemoHelper shareHelper] hangupCallWithReason:EMCallEndReasonDecline withEmcall:_callSession];
